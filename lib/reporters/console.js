// ## console.js
// Defines a jspinch reporter for the console.
...
Console.prototype.generate = function () {
    var errorTypes = {}, self = this, hintErrors = self.errors;
    var genericReport = self.genericReport(hintErrors);
    var columns = process.env.COLUMNS || 80;
    if (genericReport.totalErrors === 0) {
